...
func init() {
	...
	*/
	message[CMD_E2B_IN_MONEY_REQ] = &E2BInMoneyReq{}   //0x11010007                     // 银行服务向银行入金请求
	message[CMD_E2B_IN_MONEY_RSP] = &E2BInMoneyRsp{}   //0x11010008                     // 银行服务向银行入金应答
	message[CMD_E2B_OUT_MONEY_REQ] = &E2BOutMoneyReq{} //0x11010009                    // 银行服务向银行出金请求
	message[CMD_E2B_OUT_MONEY_RSP] = &E2BOutMoneyRsp{} //0x1101000A                    // 银行服务向银行出金应答
	/*
